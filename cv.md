...
function numberOfCarries(a, b) {
  ...
  if (range1 > range2) return countCarries(range1, range2, stringified, 1);
  else return countCarries(range2, range1, stringified, 0);
}
...
[Online Zoo](https://almondchips.github.io/online-zoo/online-zoo/pages/main/index.html)\
![изображение](https://github.com/user-attachments/assets/a7d1ce7b-861f-4ff5-8560-3d740b41e0e0)

[Bird Song](https://almondchips.github.io/Song-Bird/)\
